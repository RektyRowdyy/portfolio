  ...
  return (
    <ThemeProvider value={{ themeMode, lightTheme, darkTheme }} >
      <div className='bg-violet-200 dark:bg-gray-600 w-full h-screen flex flex-col items-center justify-center'>
        ...
        <h1 className='text-4xl font-bold'>Hridya Dham</h1>
        <h1 className='text-3xl font-light inline-flex items-center mt-3'>
          <Typewriter
            options={{
              strings: ['SOFTWARE DEVELOPER', 'OPEN SOURCE CONTRIBUTOR', 'STREAMER (wannabe)'],
              autoStart: true,
              loop: true,
            }}
          />
