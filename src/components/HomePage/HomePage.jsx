...
export default function HomePage() {
    return (
        <section className="bg-violet-200 dark:bg-gray-600 w-full h-screen flex flex-col items-center justify-center px-4">
            {/* SVG Icon */}
            <svg
            ...
            {/* Heading */}
            <h1 className="text-3xl md:text-4xl font-bold dark:text-white font-mono text-center">
                Hridya Dham
            </h1>

            {/* Typewriter Section */}
            <h1 className="text-lg md:text-2xl font-light inline-flex items-center mt-3 dark:text-white text-center">
                <Typewriter
                    options={{
                        strings: [
                            'SOFTWARE DEVELOPER 💻',
                            ...
                            'STREAMER 🎮 (wannabe)',
                            'GYMMING (trying to bulk since 2000) 🥲'
                        ],
                        autoStart: true,
                        loop: true,
                        deleteSpeed: 50,
